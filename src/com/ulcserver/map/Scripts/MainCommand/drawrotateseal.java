...
public class drawrotateseal implements Handler
{

	@Override
	public boolean shouldHandle(String str) 
	{
		return str.startsWith("do-rotate-seal");
	}
	...
	public void execute(Executer l, String line) 
	{
		...
		double rotatecount=Double.valueOf(line.split(" ")[5]);
		double angle=Double.valueOf(line.split(" ")[6]);
		Seal c=new Seal(r);
		c.calc();
